export const experienceData = {
  ...
  workDone: [
    "Developed a full-stack jewelry e-commerce platform using Next.js with dynamic catalog, Razorpay integration, Strapi CMS, Cloudinary optimization, Zustand state management, and reCAPTCHA security.",
    "Built a meal planning app with React, TypeScript, Node.js, and MySQL featuring JWT authentication, multi-language support, parent-child profiles, meal cart, and EuPlatesc payment gateway.",
    "Created a React-based web app integrating dual AI models (custom + OpenAI) via Python APIs for document analysis, split-view processing, and dynamic JSON-to-form generation.",
    "Engineered a sports management platform using React, Node.js, and MSSQL AWS EC2 backend deployment, and AWS Amplify-hosted responsive UI.",
  ],
  techStack:
    "Next.js, React.js, TypeScript, Node.js, MySQL, MSSQL, Strapi CMS, Zustand, Cloudinary, AWS EC2, AWS Amplify, Tailwind CSS, Shadcn UI",
...
export const projects = [
  ...
  },
  {
    ...
    tags: ["React.js", "Node.js", "Express.js", "MongoDB", "Zustand", "Tailwind"],
